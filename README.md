# CurRes26 - CS(SE): Computer Science with Software Engineering
...
This repository holds the governance-ready module descriptors for CS(SE) only. CS(SE) is one of four pathways in the restructured BSc computing programme; the others (Computer Science with Artificial Intelligence and Data Science, Information Technology for Business, and Network Engineering and Cybersecurity) are governed and versioned separately.

---

## 1. Programme Context

The BSc computing programme is delivered in two stages:
...
Eleven modules, 37 credits, at Level 3:
...
A further two modules (Industry Horizons, Professional Practice Foundations - 4 credits) form the Diploma's exit block and are required only for students exiting the programme at Diploma level. Including the exit block, the Diploma exit stands at **13 modules, 41 credits**.

### Year 2 - Higher Diploma Stage

Thirteen modules, 39 credits, at Level 4 (12 of the thirteen are credit-bearing; CREST is mandatory and pass/fail but non-credit):
...
| Pathway (SE) skills | Capstone Project, Industrial Training | 10 |
| Pathway (SE) taught | Enterprise Application Development, Web and Cloud Application Development, Mobile Application Development I, Software Quality and Testing, User Experience and Interaction Design, IoT Application Development, AI-Enabled Application Development, Business and Project Management Practice | 24 |

A further two modules (Professional Standing and Career Strategy, Ethics and Responsibility in Computing Practice - 4 credits) form the Higher National Diploma's exit block. Including the exit block, the HND exit stands at **15 modules, 43 credits**.
...
- **AI-Enabled Application Development and IoT Application Development are both use-not-build modules** by design: neither teaches model-building or embedded-hardware depth. Model-building depth belongs to the AI&DS pathway; embedded-hardware depth is out of scope across the whole programme. Both are flagged internally for review at the programme's next external validation point, alongside Business and Project Management Practice, since none of the three rests on a hard downstream feeder requirement in the way most other modules do.
...
| NB-SOCE-L4-SE-SK-01 | Capstone Project | Pathway (SE) skills | 5 | [Descriptor](modules/L4-Year2-HigherDiploma/NB-SOCE-L4-SE-SK-01_CapstoneProject_Gov_v1.0.docx) |
| NB-SOCE-L4-SE-SK-02 | Industrial Training | Pathway (SE) skills | 5 | [Descriptor](modules/L4-Year2-HigherDiploma/NB-SOCE-L4-SE-SK-02_IndustrialTraining_Gov_v1.0.docx) |
